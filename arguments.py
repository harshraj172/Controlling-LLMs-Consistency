...
def solicit_params():
  ...
  parser.add_argument("--model", default='gpt', type=str, choices=['t5', 'gpt', 'godel', 'aug', 'bert'],
  ...
  parser.add_argument("--ablate", type=str,
        choices=['instruction', 'attributes', 'domain_text', 'instruction_and_attributes'],
        help='ablations to run for MSP'
      )
